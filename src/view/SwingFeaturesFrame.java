...
public class SwingFeaturesFrame extends JFrame implements
  ...
  /**
   * SwingFeaturesFrame class checks to make sure swingfeatures class works.
   */
  ...
  public void actionPerformed(ActionEvent arg) {
    switch (arg.getActionCommand()) {
      ...
      case "Size options":
        ...
        break;
      case "Color chooser":
        Color col = JColorChooser.showDialog(SwingFeaturesFrame.this,
      ...
      case "Message":
        JOptionPane.showMessageDialog(SwingFeaturesFrame.this,
                "This is a demo message", "Message", JOptionPane.PLAIN_MESSAGE);
        JOptionPane.showMessageDialog(SwingFeaturesFrame.this,
                "You are about to be deleted.", "Last Chance",
                JOptionPane.WARNING_MESSAGE);
        JOptionPane.showMessageDialog(SwingFeaturesFrame.this,
                "You have been deleted.", "Too late", JOptionPane.ERROR_MESSAGE);
        JOptionPane.showMessageDialog(SwingFeaturesFrame.this,
      ...
      case "Input":
        ...
        break;
      case "Option": {
        String[] options = {"Uno", "Dos", "Tres", "Cuatro", "Cinco",
  ...
  public void valueChanged(ListSelectionEvent e) {
    ...
    JOptionPane.showMessageDialog(SwingFeaturesFrame.this,
            "The current string item is " +
                    this.listOfStrings.getSelectedValue(), "Selected string",
            JOptionPane.PLAIN_MESSAGE);
